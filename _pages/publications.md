...
*  Rebaudo, G. and Müller, P. (2024) **Graph-aligned random partition model (GARP).** *Journal of the American Statistical Association (T & M)*, in press, 1–12. [[link]](https://www.tandfonline.com/doi/full/10.1080/01621459.2024.2353943) [[arXiv]](https://arxiv.org/abs/2306.08485)
...
* Catalano, M., Franzolini, B., Giordano, M., and Rebaudo, G. (2024) **A discussion on: "Sparse Bayesian factor analysis when the number of factors is unknown" by Frühwirth-Schnatter, S., Hosszejni D., and Lopes, H. F.** *Bayesian Analysis*, in press, 95–97. [[link]](https://projecteuclid.org/journals/bayesian-analysis/advance-publication/Sparse-Bayesian-Factor-Analysis-When-the-Number-of-Factors-Is/10.1214/24-BA1423.full)
